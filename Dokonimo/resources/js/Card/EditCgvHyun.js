...
class EditCgvHyun extends Component{
  constructor(props){
    super(props);
    this.state = {
      keeper_store_name:'',
  ...
  editCgvhyun(newCgvhyun){
    axios.request({
      method:'put',
      url:'/api/kstoreinfos/11',
      data: newCgvhyun
    }).then(response => {
